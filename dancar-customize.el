(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (buffer-move yasnippet web-mode undo-tree tabbar smex scss-mode paredit org nyan-mode multiple-cursors markdown-mode json-mode js3-mode js2-mode ivy ido-ubiquitous idle-highlight-mode highlight-symbol helm-ls-git helm-git git-timemachine git-rebase-mode git-commit-mode git-commit expand-region exec-path-from-shell deft color-theme auto-complete ag)))
